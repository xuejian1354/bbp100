...
PRODUCT_COPY_FILES +=	\
	...
	$(PRODUCT_COPY)/etc/init.rc:root/init.rc \
	$(PRODUCT_COPY)/etc/apns-conf.xml:system/etc/apns-conf.xml \
	$(PRODUCT_COPY)/etc/init.usb.rc:root/init.bbp.usb.rc \
	$(PRODUCT_COPY)/etc/ueventd.bbp.rc:root/ueventd.bbp.rc \
	$(PRODUCT_COPY)/etc/ppp/init.gprs-pppd:system/etc/ppp/init.gprs-pppd \
	$(PRODUCT_COPY)/etc/ota.conf:system/etc/ota.conf \

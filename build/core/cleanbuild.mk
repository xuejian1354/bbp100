...
endif  # ifeq ($(ONE_SHOT_MAKECLEAN),)
endif  # ifndef ONE_SHOT_MAKEFILE


ifneq ($(ONE_SHOT_MAKECLEAN),)

INTERNAL_CLEAN_BUILD_VERSION := 6
CURRENT_CLEAN_STEPS :=

$(foreach stepclean,$(ONE_SHOT_MAKECLEAN), \
    $(eval include $(stepclean)))

$(foreach step,$(INTERNAL_CLEAN_STEPS), \
    $(eval CURRENT_CLEAN_STEPS += $(INTERNAL_CLEAN_STEP.$(step));))
...
INTERNAL_CLEAN_BUILD_VERSION :=
INTERNAL_CLEAN_STEPS :=
endif  # ifneq ($(ONE_SHOT_MAKECLEAN),)
